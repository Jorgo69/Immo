/**
 * Query : recherche de biens par texte (titre, ville, description) + pagination.
 */
...
export class SearchPropertiesQuery {
  @ApiProperty({ description: 'Texte de recherche (titre, ville, description)' }) @IsOptional() @IsString() q?: string;
